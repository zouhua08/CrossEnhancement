...
class lowlight_enhance(object):
    def __init__(self, sess):
        ...
        self.output_gen = Structure_Generator(self.output_0, self.output_1_2, self.output_3)
